...
Model and workspace reports read the full cwd from Codex session metadata and preserve the existing replay, fallback-model, long-context, and speed-pricing rules.
